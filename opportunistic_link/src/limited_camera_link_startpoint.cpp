...
int main(int argc, char** argv)
{
    ...
    nhp.param(std::string("link_base_topic"), link_base_topic, std::string("link/camera/rgb/image"));
    ...
    CameraLinkStartpoint startpoint(nh, default_rate, camera_base_topic, link_base_topic, link_ctrl_service, rate_ctrl_service);
