...
public:
    ...
    RequestImageLinkEndpoint(ros::NodeHandle &n, std::string relay_topic, std::string data_service, std::string quality_ctrl_service, std::string rate_ctrl_service, int default_quality, double default_rate, bool override_timestamps, bool latched) : nh_(n), it_(n), repub_rate_(20.0)
    {
